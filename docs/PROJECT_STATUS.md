...
|---|---|---|---|---|---|
| Bảo Anh | `codex/pathmemory-scope-contracts` | Lock landmark-graph scope and Product API v2 handoff | Documentation/contracts complete; commit pending | Product API 2.0.0 breaking; AI service remains 1.1.0 | None |
