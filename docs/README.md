...
- `ACCESSIBILITY_QA.md`: evidence đã đo, privacy/safety audit và checklist screen-reader/device còn phải chạy.
...
- `Official`: do BTC hoặc brief công bố.
- `Observed`: thực sự nghe hoặc quan sát từ end user/mentor.
- `Measured`: có method, sample size và kết quả.
- `Assumption`: chưa được xác minh.
